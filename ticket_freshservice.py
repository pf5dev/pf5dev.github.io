...
import random
os.system('cls')
df0=pd.read_excel(r'C:\Users\268903258\Documents\docs_N3\Planilha de Categorias (Freshservice).xlsx',sheet_name='Acessos')
l0=df0['Título do Chamado'].tolist()
df1=pd.read_excel(r'C:\Users\268903258\Documents\docs_N3\Planilha de Categorias (Freshservice).xlsx',sheet_name='E-mail')
l1=df1['Título do Chamado'].tolist()
df2=pd.read_excel(r'C:\Users\268903258\Documents\docs_N3\Planilha de Categorias (Freshservice).xlsx',sheet_name='Pastas')
